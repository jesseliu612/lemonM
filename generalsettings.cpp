    ...
    ui(new Ui::GeneralSettings)
{
    ...
    connect(ui->NOImode, SIGNAL(stateChanged(int)),
            this, SLOT(NOImodeChanged(int)));
}
...
void GeneralSettings::resetEditSettings(Settings *settings)
{
    ...
    ui->NOImode->setChecked(editSettings->NOImode);
}
...
void GeneralSettings::NOImodeChanged(const int &x)
{
    editSettings->NOImode = x;
}
