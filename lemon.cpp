...
void Lemon::aboutLemon()
{
    ...
    text += tr("Based on Zhipeng Jia's Version 1.1 Release") + "<br>";
    ...
    text += tr("This program is under the <a href=\"http://www.gnu.org/licenses/gpl-3.0.html\">GPLv3</a> license")
            + "<br>";
    text += QString("<a href=\"http://hi.baidu.com/oimaster\">") + tr("Zhipeng Jia's blog") + "</a><br>";
    text += tr("This is a modified version of <b>Project Lemon</b><br> by Jesse, which consist of several improvent<br> in the behaviour.") + "<br>";
    text += tr("You should have received the source code<br> of this software.") + "<br>";
    QMessageBox::about(this, tr("About Lemon M"), text);
}
