...
public:
    ...
    void setupUi(QWizard *AddCompilerWizard)
    {
        ...
        pythonBytecodeCheck->setObjectName(QString::fromUtf8("pythonBytecodeCheck"));
        pythonBytecodeCheck->setStyleSheet(QString::fromUtf8("font-size:10pt;"));
    ...
    void retranslateUi(QWizard *AddCompilerWizard)
    {
        ...
        pythonBytecodeCheck->setText(QApplication::translate("AddCompilerWizard", "Generate Optimized Byte-code", 0, QApplication::UnicodeUTF8));
