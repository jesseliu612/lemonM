...
public:
    ...
    void setupUi(QWidget *GeneralSettings)
    {
        ...
        GeneralSettings->resize(325, 417);
        ...
        NOImode = new QCheckBox(GeneralSettings);
        NOImode->setObjectName(QString::fromUtf8("NOImode"));

        gridLayout->addWidget(NOImode, 10, 0, 1, 2);
    ...
    void retranslateUi(QWidget *GeneralSettings)
    {
        ...
        NOImode->setText(QApplication::translate("GeneralSettings", "NOI style source code mode", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
