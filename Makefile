...
# Generated by qmake (2.01a) (Qt 4.8.7) on: ?? 6? 19 22:03:51 2018
# Project:  lemon.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.6_static/bin/qmake -o Makefile lemon.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -Wall -W -D_REENTRANT $(DEFINES) -static
INCPATH       = -I/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.8.6_static/include/QtCore -I/usr/local/Trolltech/Qt-4.8.6_static/include/QtNetwork -I/usr/local/Trolltech/Qt-4.8.6_static/include/QtGui -I/usr/local/Trolltech/Qt-4.8.6_static/include -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.8.6_static/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.8.6_static/lib -lQtGui -L/usr/local/Trolltech/Qt-4.8.6_static/lib -L/usr/X11R6/lib -ltiff -lgobject-2.0 -lSM -lICE -lXrender -lfontconfig -lfreetype -lXext -lX11 -lQtNetwork -lQtCore -lm -ldl -lgthread-2.0 -pthread -lglib-2.0 -lrt -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/local/Trolltech/Qt-4.8.6_static/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
SOURCES       = main.cpp \
		...
		addcompilerwizard.cpp moc_lemon.cpp \
		moc_contest.cpp \
		moc_task.cpp \
		moc_testcase.cpp \
		moc_settings.cpp \
...
OBJECTS       = main.o \
		...
		qrc_resource.o
DIST          = /usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/g++-base.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/g++-unix.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/qt_functions.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/qt_config.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/exclusive_builds.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/default_pre.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/release.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/default_post.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/static.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/unix/gdb_dwarf_index.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/warn_on.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/qt.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/unix/thread.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/moc.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/resources.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/uic.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/yacc.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/lex.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/include_source_dir.prf \
		lemon.pro
QMAKE_TARGET  = lemon
DESTDIR       = 
TARGET        = lemon
...
Makefile: lemon.pro  /usr/local/Trolltech/Qt-4.8.6_static/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/g++-base.conf \
		...
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/lex.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/features/include_source_dir.prf \
		/usr/local/Trolltech/Qt-4.8.6_static/lib/libQtGui.prl \
		/usr/local/Trolltech/Qt-4.8.6_static/lib/libQtCore.prl \
		/usr/local/Trolltech/Qt-4.8.6_static/lib/libQtNetwork.prl
	$(QMAKE) -o Makefile lemon.pro
/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/unix.conf:
/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/linux.conf:
/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/gcc-base.conf:
/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/gcc-base-unix.conf:
/usr/local/Trolltech/Qt-4.8.6_static/mkspecs/common/g++-base.conf:
...
moc_lemon.cpp: lemon.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) lemon.h -o moc_lemon.cpp

moc_contest.cpp: globaltype.h \
		contest.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) contest.h -o moc_contest.cpp

moc_task.cpp: task.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) task.h -o moc_task.cpp

moc_testcase.cpp: testcase.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) testcase.h -o moc_testcase.cpp

moc_settings.cpp: settings.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) settings.h -o moc_settings.cpp

moc_compiler.cpp: compiler.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) compiler.h -o moc_compiler.cpp

moc_filelineedit.cpp: filelineedit.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) filelineedit.h -o moc_filelineedit.cpp

moc_summarytree.cpp: summarytree.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) summarytree.h -o moc_summarytree.cpp

moc_taskeditwidget.cpp: taskeditwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) taskeditwidget.h -o moc_taskeditwidget.cpp

moc_testcaseeditwidget.cpp: testcaseeditwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) testcaseeditwidget.h -o moc_testcaseeditwidget.cpp

moc_generalsettings.cpp: generalsettings.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) generalsettings.h -o moc_generalsettings.cpp

moc_compilersettings.cpp: compilersettings.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) compilersettings.h -o moc_compilersettings.cpp

moc_addtestcaseswizard.cpp: addtestcaseswizard.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) addtestcaseswizard.h -o moc_addtestcaseswizard.cpp

moc_contestant.cpp: globaltype.h \
		contestant.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) contestant.h -o moc_contestant.cpp

moc_judgingdialog.cpp: globaltype.h \
		judgingdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) judgingdialog.h -o moc_judgingdialog.cpp

moc_judgingthread.cpp: globaltype.h \
		judgingthread.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) judgingthread.h -o moc_judgingthread.cpp

moc_optionsdialog.cpp: optionsdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) optionsdialog.h -o moc_optionsdialog.cpp

moc_resultviewer.cpp: resultviewer.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) resultviewer.h -o moc_resultviewer.cpp

moc_assignmentthread.cpp: globaltype.h \
		assignmentthread.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) assignmentthread.h -o moc_assignmentthread.cpp

moc_detaildialog.cpp: detaildialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) detaildialog.h -o moc_detaildialog.cpp

moc_newcontestwidget.cpp: newcontestwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) newcontestwidget.h -o moc_newcontestwidget.cpp

moc_opencontestwidget.cpp: opencontestwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) opencontestwidget.h -o moc_opencontestwidget.cpp

moc_newcontestdialog.cpp: newcontestdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) newcontestdialog.h -o moc_newcontestdialog.cpp

moc_opencontestdialog.cpp: opencontestdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) opencontestdialog.h -o moc_opencontestdialog.cpp

moc_welcomedialog.cpp: welcomedialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) welcomedialog.h -o moc_welcomedialog.cpp

moc_addtaskdialog.cpp: addtaskdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) addtaskdialog.h -o moc_addtaskdialog.cpp

moc_qtsinglecoreapplication.cpp: qtsingleapplication/qtsinglecoreapplication.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) qtsingleapplication/qtsinglecoreapplication.h -o moc_qtsinglecoreapplication.cpp

moc_qtsingleapplication.cpp: qtsingleapplication/qtsingleapplication.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) qtsingleapplication/qtsingleapplication.h -o moc_qtsingleapplication.cpp

moc_qtlocalpeer.cpp: qtlockedfile/qtlockedfile.h \
		qtsingleapplication/qtlocalpeer.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) qtsingleapplication/qtlocalpeer.h -o moc_qtlocalpeer.cpp

moc_advancedcompilersettingsdialog.cpp: advancedcompilersettingsdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) advancedcompilersettingsdialog.h -o moc_advancedcompilersettingsdialog.cpp

moc_environmentvariablesdialog.cpp: environmentvariablesdialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) environmentvariablesdialog.h -o moc_environmentvariablesdialog.cpp

moc_editvariabledialog.cpp: editvariabledialog.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) editvariabledialog.h -o moc_editvariabledialog.cpp

moc_addcompilerwizard.cpp: addcompilerwizard.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/moc $(DEFINES) $(INCPATH) addcompilerwizard.h -o moc_addcompilerwizard.cpp
...
qrc_resource.cpp: resource.qrc \
		...
		realjudge_linux \
		realjudge_win32.exe
	/usr/local/Trolltech/Qt-4.8.6_static/bin/rcc -name resource resource.qrc -o qrc_resource.cpp
...
ui_lemon.h: forms_unix/lemon.ui \
		...
		resultviewer.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/lemon.ui -o ui_lemon.h

ui_taskeditwidget.h: forms_unix/taskeditwidget.ui \
		filelineedit.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/taskeditwidget.ui -o ui_taskeditwidget.h

ui_testcaseeditwidget.h: forms_unix/testcaseeditwidget.ui \
		filelineedit.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/testcaseeditwidget.ui -o ui_testcaseeditwidget.h

ui_generalsettings.h: forms_unix/generalsettings.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/generalsettings.ui -o ui_generalsettings.h

ui_compilersettings.h: forms_unix/compilersettings.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/compilersettings.ui -o ui_compilersettings.h

ui_addtestcaseswizard.h: forms_unix/addtestcaseswizard.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/addtestcaseswizard.ui -o ui_addtestcaseswizard.h

ui_judgingdialog.h: forms_unix/judgingdialog.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/judgingdialog.ui -o ui_judgingdialog.h

ui_optionsdialog.h: forms_unix/optionsdialog.ui \
		generalsettings.h \
		compilersettings.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/optionsdialog.ui -o ui_optionsdialog.h

ui_detaildialog.h: forms_unix/detaildialog.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/detaildialog.ui -o ui_detaildialog.h

ui_newcontestwidget.h: forms_unix/newcontestwidget.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/newcontestwidget.ui -o ui_newcontestwidget.h

ui_opencontestwidget.h: forms_unix/opencontestwidget.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/opencontestwidget.ui -o ui_opencontestwidget.h

ui_newcontestdialog.h: forms_unix/newcontestdialog.ui \
		newcontestwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/newcontestdialog.ui -o ui_newcontestdialog.h

ui_opencontestdialog.h: forms_unix/opencontestdialog.ui \
		opencontestwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/opencontestdialog.ui -o ui_opencontestdialog.h

ui_welcomedialog.h: forms_unix/welcomedialog.ui \
		opencontestwidget.h \
		newcontestwidget.h
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/welcomedialog.ui -o ui_welcomedialog.h

ui_addtaskdialog.h: forms_unix/addtaskdialog.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/addtaskdialog.ui -o ui_addtaskdialog.h

ui_advancedcompilersettingsdialog.h: forms_unix/advancedcompilersettingsdialog.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/advancedcompilersettingsdialog.ui -o ui_advancedcompilersettingsdialog.h

ui_environmentvariablesdialog.h: forms_unix/environmentvariablesdialog.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/environmentvariablesdialog.ui -o ui_environmentvariablesdialog.h

ui_editvariabledialog.h: forms_unix/editvariabledialog.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/editvariabledialog.ui -o ui_editvariabledialog.h

ui_addcompilerwizard.h: forms_unix/addcompilerwizard.ui
	/usr/local/Trolltech/Qt-4.8.6_static/bin/uic forms_unix/addcompilerwizard.ui -o ui_addcompilerwizard.h
